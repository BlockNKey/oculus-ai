...
export function buildCarousel(targets, { radiusX = 200, radiusY = 200, activeAngle = -90, activeElement, onClick, onActivate, onDeactivate, onStart, onStop, draggable, autoAdvance }) {
        ...
        self = {
          ...
          render() {
            ...
            for (; i < quantity; i++) {
              ...
              ySetters[i](round((Math.sin(a) * radiusY) - (radiusY / 3)));
              a += inc;
            }
          },
          activeElement(value) {
